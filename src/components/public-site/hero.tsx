  ...
  return (
    <section className="relative min-h-screen lg:h-screen flex items-center overflow-hidden py-24 lg:py-0">
      ...
      <div className="relative z-10 px-4 sm:px-6 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] items-center gap-12 mt-12">
        <div>
          <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 bg-primary/10 border border-primary/20 rounded-full mb-6">
            <span className="w-2 h-2 rounded-full bg-primary animate-pulse"></span>
            <span className="text-primary text-[10px] font-black tracking-[0.2em] uppercase">Now Open in Nallur & Town</span>
          </div>

          <h1 className="text-[2rem] sm:text-[3.2rem] lg:text-[6rem] leading-[0.9] font-black uppercase tracking-tighter mb-6 sm:mb-8 font-headline">
            Architect Your <br/>
            <span className="text-primary italic">Kinetic Edge</span> <br/>
            In Jaffna.
          </h1>

          <p className="text-on-surface-variant text-base sm:text-lg lg:text-xl mb-8 sm:mb-10 max-w-xl font-body leading-relaxed">
